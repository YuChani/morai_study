...
from detection_msgs.msg import Traffic_status
...
class erp_planner():
    def __init__(self):
        ...
        rospy.Subscriber("/Traffic_light", Traffic_status, self.tf_light_callback)
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_status==True  and self.is_obj==True:
                ...
                lattice_path,selected_lane,self.look_dist=latticePlanner(local_path,global_obj,vehicle_status,lattice_current_lane)
    ...
    def print_info(self):
        ...
        print('--------------------obstacle-------------------------')
        print('obstacle {0} ,{1}, {2},{3},{4} '.format(self.object_num,self.object_info[0],self.object_info[1],self.object_info[2],self.object_info[3],self.look_dist))
